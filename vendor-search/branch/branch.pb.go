...
type Branch struct {
	...
	PublicPhoneNumber           string                 `protobuf:"bytes,16,opt,name=public_phone_number,json=publicPhoneNumber,proto3" json:"public_phone_number,omitempty"`
	...
	HelloFoodVendorCode         string                 `protobuf:"bytes,29,opt,name=hello_food_vendor_code,json=helloFoodVendorCode,proto3" json:"hello_food_vendor_code,omitempty"`
	...
	LinkToken                   string                 `protobuf:"bytes,32,opt,name=link_token,json=linkToken,proto3" json:"link_token,omitempty"`
	...
	SalesforceGrid              string                 `protobuf:"bytes,40,opt,name=salesforce_grid,json=salesforceGrid,proto3" json:"salesforce_grid,omitempty"`
	...
	SalesforceId                string                 `protobuf:"bytes,43,opt,name=salesforce_id,json=salesforceId,proto3" json:"salesforce_id,omitempty"`
	...
	CommissionBase              string                 `protobuf:"bytes,46,opt,name=commission_base,json=commissionBase,proto3" json:"commission_base,omitempty"`
	FinanceSpecefication        string                 `protobuf:"bytes,47,opt,name=finance_specefication,json=financeSpecefication,proto3" json:"finance_specefication,omitempty"`
...
func (x *Branch) GetPublicPhoneNumber() string {
	if x != nil {
...
func (x *Branch) GetHelloFoodVendorCode() string {
	if x != nil {
...
func (x *Branch) GetLinkToken() string {
	if x != nil {
		return x.LinkToken
	}
	return ""
...
func (x *Branch) GetSalesforceGrid() string {
	if x != nil {
...
func (x *Branch) GetSalesforceId() string {
	if x != nil {
...
func (x *Branch) GetCommissionBase() string {
	if x != nil {
...
func (x *Branch) GetFinanceSpecefication() string {
	if x != nil {
...
var file_vendor_search_branch_branch_proto_rawDesc = []byte{
	...
	0x6d, 0x62, 0x65, 0x72, 0x18, 0x10, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x70, 0x75, 0x62, 0x6c,
	...
	0x64, 0x6f, 0x72, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13,
	...
	0x09, 0x52, 0x09, 0x6c, 0x69, 0x6e, 0x6b, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x28, 0x0a, 0x10,
	...
	0x64, 0x18, 0x28, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x61, 0x6c, 0x65, 0x73, 0x66, 0x6f,
	...
	0x6f, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x2b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73,
	...
	0x61, 0x73, 0x65, 0x18, 0x2e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x63, 0x6f, 0x6d, 0x6d, 0x69,
	...
	0x6f, 0x6e, 0x18, 0x2f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x66, 0x69, 0x6e, 0x61, 0x6e, 0x63,
	...
	0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x42, 0x3e, 0x5a, 0x14, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72,
	0x2d, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x2f, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0xea, 0x02,
